...
class SignUpViewModel: ViewModel() {
    ...
    fun registerDetail(userEmail: String, userName: String, userPassword: String, context: Context): Boolean {
        ...
        return if (!isValidEmail && !isValidName) {
            ...
            return register(userEmail, userName, userPassword, context)
        }
    }

    private fun register(userEmail: String, userName: String, userPassword: String, context: Context): Boolean {
